<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="telpon" value="{{ __('Telpon') }}" />
                <x-jet-input id="telpon" class="block mt-1 w-full" type="text" name="telpon" :value="old('telpon')" required />
            </div>
            ...
            <div class="mt-4">
              ...
              <div>
                <x-jet-label for="akses" value="{{ __('Akses') }}" />
                <select class="block mt-1 w-full" id="akses" name="akses" :value="old('akses')" required autofocus autocomplete="akses">
